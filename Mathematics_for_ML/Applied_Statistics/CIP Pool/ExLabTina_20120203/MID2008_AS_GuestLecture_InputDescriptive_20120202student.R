...
#This is r-code without the commands for the student tasks
#You find the same code with the commands for the student tasks in MID2008_AS_GuestLecture_InputDescriptive_20120202acomplete.R  

setwd("u:\\")

#Data sets in the folder ExLab5_MID2008_Descriptive\\:
#p2008extendedASFor20120203.Rdata: basis for this file, to be loaded in the beginning
...
#see 2011-11-10_MiD2008_Information_en.docx  for variable/filter description
