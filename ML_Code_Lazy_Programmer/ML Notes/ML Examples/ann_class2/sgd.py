# DEEP LEARNING IN THEANO AND TENSORFLOW 
# ======================================


# In this file we compare the progression 
# of the cost function vs. iteration
...
from util import get_transformed_data, forward, error_rate, \
    cost, gradW, gradb, y2indicator
