...
# After Clean
# -----------
reg_after_cleaned = LinearRegression()
...
reg_after_cleaned.fit(age_cleaned, net_worth_cleaned)

print 'Coefficient: ',reg_after_cleaned.coef_[0][0]
print '##### Stats on Test dataset ####'
print 'r-squared score: ', reg_after_cleaned.score(ages_test,net_worths_test)
